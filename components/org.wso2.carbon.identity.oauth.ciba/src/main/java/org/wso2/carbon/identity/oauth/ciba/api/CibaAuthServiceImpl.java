...
public class CibaAuthServiceImpl implements CibaAuthService {
    ...
    public CibaAuthResponseDTO generateAuthResponseDTO(CibaAuthRequestDTO cibaAuthRequestDTO) throws CibaCoreException {
        ...
        // Build DO that is to be persisted.
        CibaAuthCodeDO cibaAuthCodeDO = generateCibaAuthCodeDO(cibaAuthRequestDTO);

        // Persist DO.
        persistCibaAuthCode(cibaAuthCodeDO);

        // Return built ResponseDTO.
        return buildAuthResponseDTO(cibaAuthRequestDTO, cibaAuthCodeDO);
    }
     ...
     */
    private static long getExpiresIn(CibaAuthRequestDTO cibaAuthRequestDTO) {
     ...
     *
     * @param cibaAuthRequestDTO CIBA Request Data Transfer Object.
     * @return CibaAuthCodeDO.
     */
    private static CibaAuthCodeDO generateCibaAuthCodeDO(CibaAuthRequestDTO cibaAuthRequestDTO) {
        ...
        long expiryTime = getExpiresIn(cibaAuthRequestDTO);
     ...
     */
    private static CibaAuthResponseDTO buildAuthResponseDTO(CibaAuthRequestDTO cibaAuthRequestDTO,
