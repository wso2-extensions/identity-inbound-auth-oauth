 ...
 */
public class EmailCibaNotificationChannel implements CibaNotificationChannel {

    private static final Log log = LogFactory.getLog(EmailCibaNotificationChannel.class);
    ...
    private static final String EMAIL_ADDRESS = "http://wso2.org/claims/emailaddress";
    ...
    public void sendNotification(CibaUserResolver.ResolvedUser resolvedUser, CibaAuthCodeDO cibaAuthCodeDO, String authUrl,
        ...
        try {
            ...
            properties.put("user.claim.givenname", resolvedUser.getFirstName());
