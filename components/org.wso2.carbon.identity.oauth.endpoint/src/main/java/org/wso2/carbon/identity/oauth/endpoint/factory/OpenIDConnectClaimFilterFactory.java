 ...
 */
public class OpenIDConnectClaimFilterFactory extends AbstractFactoryBean<OpenIDConnectClaimFilterImpl> {

    private OpenIDConnectClaimFilterImpl openIDConnectClaimFilter;

    @Override
    public Class<OpenIDConnectClaimFilterImpl> getObjectType() {
