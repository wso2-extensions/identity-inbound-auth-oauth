...
/**
 * Factory class for ParAuthService.
 */
public class ParAuthServiceFactory {

    private static final ParAuthService SERVICE;

    static {
        ParAuthService parAuthService = (ParAuthService) PrivilegedCarbonContext.getThreadLocalCarbonContext()
