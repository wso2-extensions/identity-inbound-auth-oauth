...
public class OAuthServerConfigurationTest {
    ...
    public void testGetValueForIsRefreshTokenAllowed(String gratType, String defaultValue, String expectedValue) {

        String refreshAllowed = OAuthServerConfiguration.getInstance().
                getValueForIsRefreshTokenAllowed(gratType, defaultValue);
