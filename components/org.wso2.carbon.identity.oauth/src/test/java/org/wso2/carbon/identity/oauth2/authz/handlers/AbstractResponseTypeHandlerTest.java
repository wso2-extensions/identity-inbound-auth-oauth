...
public class AbstractResponseTypeHandlerTest {
    ...
    public void setUp() throws Exception {
        ...
        Field oAuthCallbackHandlerRegistry = OAuthServerConfiguration.class.getDeclaredField("instance");
        oAuthCallbackHandlerRegistry.setAccessible(true);
        oAuthCallbackHandlerRegistry.set(null, null);

        Field oAuthServerConfigInstance = OAuthServerConfiguration.class.getDeclaredField("instance");
    ...
    public void testValidateAccessDelegation(String grantType, boolean result) throws Exception {
        Assert.assertEquals(abstractResponseTypeHandler.
                ...
                "Access Delegation not set");
    }

    @Test
    public void testValidateScope() throws Exception {
        Assert.assertTrue(abstractResponseTypeHandler.validateScope(this.setSampleOAuthReqMessageContext(null)),
    ...
    public void testIsAuthorizedClient(String grantType, boolean result) throws Exception {
        Assert.assertEquals(
                abstractResponseTypeHandler.isAuthorizedClient(this.setSampleOAuthReqMessageContext(grantType)),
                result);
    }

    @DataProvider(name = "grantTypeProvider")
    public static Object[][] grantTypes() {
        return new Object[][] { { null, true }, { "authorization_code", true }, { "dummy_code", false },
                { "implicit", true }, { "dummy_code_2", false } };
    }

    @DataProvider(name = "grantTypeProvider2")
    public static Object[][] grantTypes2() {
        return new Object[][] { { null, false }, { "authorization_code", true }, { "dummy_code", false } };
    }
    ...
    private OAuthAuthzReqMessageContext setSampleOAuthReqMessageContext(String grantType) {
        ...
        OAuthAuthzReqMessageContext oAuthAuthzReqMessageContext = new OAuthAuthzReqMessageContext(authorizationReqDTO);
