...
public class RequestObjectDAOImplTest {
    ...
    private void testInsertRequestObject() throws IdentityOAuth2Exception {
        ...
        requestObjectDAO.getRequestedClaims("d43e8da324a33bdc941b9b95cad6a6a2", null, true);
        Assert.assertEquals(requestObjectDAO.getRequestedClaims("code1", null, true).size(), 0);
    }
}