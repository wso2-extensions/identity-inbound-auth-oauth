...
/**
 * Unit test cases for OAuth2OIDCConfigUtils class.
 */
@WithCarbonHome
@Listeners(MockitoTestNGListener.class)
public class OAuth2OIDCConfigUtilsTest {
    ...
    public void testGetDefaultIssuerUsageScopeConfig(String tenantDomain, String orgId, String expectedIssuer)
        ...
        IssuerUsageScopeConfig result = OAuth2OIDCConfigUtils.getDefaultIssuerUsageScopeConfig(tenantDomain);
    ...
    public void testGetDefaultIssuerUsageScopeConfigWithException() throws Exception {
        ...
        OAuth2OIDCConfigUtils.getDefaultIssuerUsageScopeConfig(PRIMARY_TENANT_DOMAIN);
    }
    ...
    public void testGetIssuerLocationForOrganization(String tenantDomain, String orgId, boolean isPrimaryOrg,
        ...
        String result = OAuth2OIDCConfigUtils.getIssuerLocation(tenantDomain);
    ...
    public void testGetIssuerLocationRestoresThreadLocalProperties() throws Exception {
        ...
        OAuth2OIDCConfigUtils.getIssuerLocation(PRIMARY_TENANT_DOMAIN);
    ...
    public void testGetIssuerLocationWithURLBuilderException() throws Exception {
        ...
        try {
            OAuth2OIDCConfigUtils.getIssuerLocation(SUB_ORG_TENANT_DOMAIN);
        } finally {
            privilegedCarbonContextMock.verify(PrivilegedCarbonContext::startTenantFlow, times(1));
            privilegedCarbonContextMock.verify(PrivilegedCarbonContext::endTenantFlow, times(1));
        }
    ...
    public void testHandleServerException() {
        ...
        OAuth2OIDCConfigMgtErrorMessages error =
                OAuth2OIDCConfigMgtErrorMessages.ERROR_CODE_OAUTH2_OIDC_CONFIG_ISSUER_BUILD;
        Throwable cause = new RuntimeException(ERROR_MESSAGE);

        OAuth2OIDCConfigMgtServerException exception =
                OAuth2OIDCConfigUtils.handleServerException(error, cause, ERROR_DATA);
    ...
    public void testHandleServerExceptionWithMultipleData() {
        ...
        OAuth2OIDCConfigMgtServerException exception =
                OAuth2OIDCConfigUtils.handleServerException(error, cause, TEST_DATA_1, TEST_DATA_2);
    ...
    public void testHandleServerExceptionWithNoData() {
        ...
        OAuth2OIDCConfigMgtErrorMessages error =
                OAuth2OIDCConfigMgtErrorMessages.ERROR_CODE_OAUTH2_OIDC_CONFIG_RETRIEVE;
        Throwable cause = new RuntimeException(ERROR_MESSAGE);

        OAuth2OIDCConfigMgtServerException exception =
                OAuth2OIDCConfigUtils.handleServerException(error, cause, (String) null);
    ...
    public void testHandleClientException() {
        ...
        OAuth2OIDCConfigMgtErrorMessages error =
                OAuth2OIDCConfigMgtErrorMessages.ERROR_CODE_OAUTH2_OIDC_CONFIG_EMPTY_PATCH_OBJECT;
        Throwable cause = new RuntimeException(ERROR_MESSAGE);

        OAuth2OIDCConfigMgtClientException exception =
                OAuth2OIDCConfigUtils.handleClientException(error, cause, ERROR_DATA);
    ...
    public void testHandleClientExceptionWithMultipleData() {
        ...
        OAuth2OIDCConfigMgtClientException exception =
                OAuth2OIDCConfigUtils.handleClientException(error, cause, TEST_DATA_1, TEST_DATA_2);
    ...
    public void testHandleClientExceptionWithNoData() {
        ...
        OAuth2OIDCConfigMgtErrorMessages error =
                OAuth2OIDCConfigMgtErrorMessages.ERROR_CODE_OAUTH2_OIDC_CONFIG_ISSUER_USAGE_SCOPE_CHANGE_REJECT;
        Throwable cause = new RuntimeException(ERROR_MESSAGE);

        OAuth2OIDCConfigMgtClientException exception =
                OAuth2OIDCConfigUtils.handleClientException(error, cause);
    ...
    public void testHandleExceptionWithNullCause() {
        ...
        OAuth2OIDCConfigMgtServerException exception =
                OAuth2OIDCConfigUtils.handleServerException(error, null, ERROR_DATA);
