...
ALTER TABLE IDN_OAUTH2_REFRESH_TOKEN_BINDING ALTER COLUMN TOKEN_BINDING_TYPE SET NOT NULL;
ALTER TABLE IDN_OAUTH2_REFRESH_TOKEN_BINDING ALTER COLUMN TOKEN_BINDING_REF SET NOT NULL;
