INSERT INTO IDN_OAUTH_CONSUMER_APPS (CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, USER_DOMAIN, APP_NAME,
            OAUTH_VERSION, CALLBACK_URL, GRANT_TYPES, APP_STATE, REFRESH_TOKEN_EXPIRE_TIME) VALUES
            ...
            'refresh_token implicit password iwa:ntlm client_credentials authorization_code', 'ACTIVE',72600);

INSERT INTO IDN_OAUTH_CONSUMER_APPS (CONSUMER_KEY, CONSUMER_SECRET, USERNAME, TENANT_ID, USER_DOMAIN, APP_NAME,
            OAUTH_VERSION, CALLBACK_URL, GRANT_TYPES, APP_STATE, REFRESH_TOKEN_EXPIRE_TIME) VALUES
            ('dabfba9390aa423f8b04332794d83614', '5dcae004fba64e3a8a7cbebfdf02fcde', 'user1', -1234, 'PRIMARY',
            'myApp', 'OAuth-2.0', 'http://localhost:8080/redirect',
            'refresh_token password iwa:ntlm client_credentials', 'ACTIVE',72600);
