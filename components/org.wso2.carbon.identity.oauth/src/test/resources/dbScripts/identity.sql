...
CREATE TABLE IF NOT EXISTS IDN_OAUTH_CONSUMER_APPS (
            ...
            CONSTRAINT UK_TENANT_CONSUMER_KEY UNIQUE (CONSUMER_KEY, TENANT_ID),
            PRIMARY KEY (ID)
);
...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_DEVICE_FLOW_SCOPES (
    ...
    SCOPE VARCHAR(255),
    PRIMARY KEY (ID),
    FOREIGN KEY (SCOPE_ID) REFERENCES IDN_OAUTH2_DEVICE_FLOW(DEVICE_CODE) ON DELETE CASCADE
);
...
('c508ca28-60c0-4493-a758-77e4173ffdb9', 'IDP_SECRET_PROPERTIES',
 'Secret type to uniquely identify secrets relevant to identity providers');
