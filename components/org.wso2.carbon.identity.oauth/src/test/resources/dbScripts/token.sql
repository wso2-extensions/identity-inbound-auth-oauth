...
CREATE TABLE IF NOT EXISTS IDN_OAUTH2_ACCESS_TOKEN (
            ...
            AUTHORIZED_ORGANIZATION VARCHAR(36) DEFAULT 'NONE',
...
CREATE INDEX IF NOT EXISTS IDX_AT_CK_AU ON IDN_OAUTH2_ACCESS_TOKEN(CONSUMER_KEY_ID, AUTHZ_USER, TOKEN_STATE, USER_TYPE);
...
CREATE INDEX IF NOT EXISTS IDX_AUTHORIZATION_CODE ON IDN_OAUTH2_AUTHORIZATION_CODE (AUTHORIZATION_CODE,CONSUMER_KEY_ID);
