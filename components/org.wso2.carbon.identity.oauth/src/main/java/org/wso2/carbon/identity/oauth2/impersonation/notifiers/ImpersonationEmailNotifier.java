        ...
        try {
            ...
            if (sendEmail) {
                ...
                if (StringUtils.isNotBlank(subject.getAccessingOrganization()) &&
                    ...
                    impersonator = OAuth2Util.getAuthenticatedUser(impersonatorId, tenantDomain,
                            subject.getAccessingOrganization(), subject.getUserResidentOrganization(), clientId);
                } else {
                    impersonator = OAuth2Util.getAuthenticatedUser(impersonatorId, tenantDomain, clientId);
                }
