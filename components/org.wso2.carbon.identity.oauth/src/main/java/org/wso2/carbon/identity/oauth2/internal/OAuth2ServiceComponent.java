...
public class OAuth2ServiceComponent {
    ...
    @Reference(
            ...
            service = InternalTokenRevocationService.class,
            cardinality = ReferenceCardinality.OPTIONAL,
            policy = ReferencePolicy.DYNAMIC,
            unbind = "unsetInternalTokenRevocationService"
    )
    protected void setInternalTokenRevocationService(InternalTokenRevocationService internalTokenRevocationService) {
    ...
    protected void unsetInternalTokenRevocationService(InternalTokenRevocationService internalTokenRevocationService) {
