...
public class OAuthAdminServiceImpl {
    ...
    public String[] registerOAuthConsumer() throws IdentityOAuthAdminException {
        ...
        if (isControlPlane()) {
            ...
            publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                    ...
                    OAuthXDSOperationType.REGISTER_OAUTH_CONSUMER);
        }
            ...
            if (defaultAppOwner != null) {
                ...
                if (application != null) {
                    ...
                    if (isControlPlane()) {
                        ...
                        publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                                applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                                OAuthXDSOperationType.REGISTER_AND_RETRIEVE_OAUTH_APPLICATION_DATA);
                    }
    ...
    public void updateConsumerApplication(OAuthConsumerAppDTO consumerAppDTO) throws IdentityOAuthAdminException {
        ...
        if (isControlPlane()) {
            ...
            publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                    applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                    OAuthXDSOperationType.UPDATE_CONSUMER_APPLICATION);
        }
        ...
        try {
            if (StringUtils.isNotEmpty(scope)) {
                ...
                if (isControlPlane()) {
                    ...
                    publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                            applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                            OAuthXDSOperationType.ADD_SCOPE);
                }
    ...
    public void addScope(ScopeDTO scope) throws IdentityOAuthAdminException {
        ...
        try {
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.ADD_SCOPE_DTO);
            }
    ...
    public void deleteScope(String scope) throws IdentityOAuthAdminException {
        ...
        try {
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.DELETE_SCOPE);
            }
    ...
    public void updateScope(String scope, String[] addClaims, String[] deleteClaims)
        ...
        try {
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.UPDATE_SCOPE);
            }
    ...
    public void updateScope(ScopeDTO updatedScope) throws IdentityOAuthAdminException {
        ...
        try {
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.UPDATE_SCOPE_DTO);
            }
            OAuthTokenPersistenceFactory.getInstance().getScopeClaimMappingDAO().
    ...
    public void updateConsumerAppState(String consumerKey, String newState) throws IdentityOAuthAdminException {
        ...
        try {
            ...
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.UPDATE_CONSUMER_APP_STATE);
            }
    ...
    public OAuthConsumerAppDTO updateAndRetrieveOauthSecretKey(String consumerKey, String secretKey)
        ...
        if (isControlPlane()) {
            ...
            publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                    applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                    OAuthXDSOperationType.UPDATE_AND_RETRIEVE_OAUTH_SECRET_KEY);
        }
        Properties properties = new Properties();
    ...
    public void removeOAuthApplicationData(String consumerKey) throws IdentityOAuthAdminException {
        ...
        try {
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.REMOVE_OAUTH_APPLICATION_DATA);
            }
    ...
    public void removeAllOAuthApplicationData(int tenantId) throws IdentityOAuthAdminException {
        ...
        if (isControlPlane()) {
            ...
            publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                    applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                    OAuthXDSOperationType.REMOVE_ALL_OAUTH_APPLICATION_DATA);
        }
    ...
    public OAuthRevocationResponseDTO revokeAuthzForAppsByResourceOwner(
        ...
        if (revokeRequestDTO.getApps() != null && revokeRequestDTO.getApps().length > 0) {
            ...
            if (isControlPlane()) {
                ...
                publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.REVOKE_AUTHZ_FOR_APPS_BY_RESOURCE_OWNER);
            }
    ...
    public OAuthRevocationResponseDTO revokeIssuedTokensByApplication(OAuthAppRevocationRequestDTO application)
        ...
        if (isControlPlane()) {
            ...
            publishData(PrivilegedCarbonContext.getThreadLocalCarbonContext().getTenantDomain(),
                    applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                    OAuthXDSOperationType.REVOKE_ISSUED_TOKENS_BY_APPLICATION);
        }
        ...
        try {
            ...
            if (isControlPlane()) {
                ...
                publishData(tenantDomain,
                        applicationXDSWrapper, XDSConstants.EventType.OAUTH,
                        OAuthXDSOperationType.UPDATE_APPROVE_ALWAYS_FOR_APP_CONSENT_BY_RESOURCE_OWNER);
            }
