...
/**
 * Exception class for handling agent configuration management errors.
 */
public class AgentConfigMgtException extends Exception {
     ...
     */
    public AgentConfigMgtException() {
     ...
     */
    public AgentConfigMgtException(String message, String errorCode, Throwable cause) {
