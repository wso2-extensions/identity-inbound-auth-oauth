            ...
            try (Connection connection = IdentityDatabaseUtil.getDBConnection()) {
                try {
                    ...
                    try (PreparedStatement prepStmt = connection
                        ...
                        // If multiple client secret feature is enabled, the client secret is stored in a separate
                        // table. Hence, the client secret column in IDN_OAUTH_CONSUMER_APPS table is set to null.
