...
//            "ON ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String RETRIEVE_TOKEN_BINDING_BY_TOKEN_ID = "SELECT TOKEN_BINDING_TYPE, "
            + "TOKEN_BINDING_REF, TOKEN_BINDING_VALUE FROM IDN_OAUTH2_ACCESS_TOKEN_BIND WHERE TOKEN_ID = ?";

    public static final String RETRIEVE_TOKEN_BINDING_REF_EXISTS = "SELECT COUNT(*) AS TOTAL FROM "
            + "IDN_OAUTH2_ACCESS_TOKEN_BIND WHERE TOKEN_BINDING_REF = ?";

    public static final String STORE_TOKEN_BINDING = "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN_BIND (TOKEN_ID, "
            + "TOKEN_BINDING_TYPE, TOKEN_BINDING_REF, TOKEN_BINDING_VALUE, TENANT_ID) VALUES (?, ?, ?, ?, ?)";

    public static final String DELETE_TOKEN_BINDING_BY_TOKEN_ID = "DELETE FROM IDN_OAUTH2_ACCESS_TOKEN_BIND WHERE "
            + "TOKEN_ID = ?";
