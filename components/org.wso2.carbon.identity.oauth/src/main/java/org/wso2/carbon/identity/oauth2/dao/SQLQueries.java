...
public class SQLQueries {
    ...
    public static final String RETRIEVE_GRACEFULLY_ROTATED_ACCESS_TOKEN_BY_CLIENT_ID_USER_IDP_NAME = "SELECT " +
            "ACCESS_TOKEN, REFRESH_TOKEN, " +
            "TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
            "TOKEN_SCOPE, ACCESS_TOKEN_TABLE.TOKEN_ID, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, " +
            "AUTHORIZED_ORGANIZATION FROM (SELECT TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, " +
            ...
            " FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ? AND TENANT_ID = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
            "TOKEN_STATE='GRACEFULLY_ROTATED' AND " +
            "IDP_ID=(SELECT ID FROM IDP WHERE NAME=? AND TENANT_ID=?)) " +
            "ACCESS_TOKEN_TABLE LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON " +
            "ACCESS_TOKEN_TABLE.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID";
    ...
    public static final String GET_DISTINCT_APPS_AUTHORIZED_BY_USER_ALL_TIME = "SELECT DISTINCT CONSUMER_KEY FROM " +
            ...
            "AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED' OR TOKEN_STATE='GRACEFULLY_ROTATED')";
    ...
    public static final String RETRIEVE_REFRESH_TOKEN_BINDING_BY_REFRESH_TOKEN =
            "SELECT REFRESH_TOKEN_BINDING_TABLE.TOKEN_BINDING_TYPE, " +
                    "REFRESH_TOKEN_BINDING_TABLE.TOKEN_BINDING_VALUE, " +
                    "REFRESH_TOKEN_BINDING_TABLE.TOKEN_BINDING_REF " +
                    "FROM IDN_OAUTH2_REFRESH_TOKEN REFRESH_TOKEN_TABLE " +
                    "JOIN IDN_OAUTH2_REFRESH_TOKEN_BINDING REFRESH_TOKEN_BINDING_TABLE ON " +
                    "REFRESH_TOKEN_TABLE.REFRESH_TOKEN_ID = REFRESH_TOKEN_BINDING_TABLE.REFRESH_TOKEN_ID " +
                    "WHERE REFRESH_TOKEN_TABLE.REFRESH_TOKEN = ?";
    ...
    public static final String RETRIEVE_ACTIVE_TOKEN_BY_EXTENDED_ATTRIBUTE =
            "SELECT T.ACCESS_TOKEN, T.TOKEN_ID, T.TIME_CREATED, T.REFRESH_TOKEN_TIME_CREATED, " +
                    "T.VALIDITY_PERIOD, T.REFRESH_TOKEN_VALIDITY_PERIOD " +
                    "FROM IDN_OAUTH2_ACCESS_TOKEN T " +
                    "INNER JOIN IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES A ON T.TOKEN_ID = A.TOKEN_ID " +
                    "WHERE A.TOKEN_ATTR_NAME = ? AND A.TOKEN_ATTR_VALUE = ? " +
                    "AND T.TOKEN_STATE IN ('ACTIVE', 'GRACEFULLY_ROTATED')";
    ...
    public static class RefreshTokenPersistenceSQLQueries {
        ...
        public static final String RETRIEVE_LATEST_ACTIVE_REFRESH_TOKEN_BY_CLIENT_ID_USER_SCOPE_BINDING = "SELECT " +
                "REFRESH_TOKEN_TABLE.REFRESH_TOKEN, REFRESH_TOKEN_TABLE.REFRESH_TOKEN_TIME_CREATED, " +
                "REFRESH_TOKEN_TABLE.REFRESH_TOKEN_VALIDITY_PERIOD, REFRESH_TOKEN_TABLE.REFRESH_TOKEN_ID, " +
                "REFRESH_TOKEN_TABLE.SUBJECT_IDENTIFIER, REFRESH_TOKEN_TABLE.CONSENTED_TOKEN, " +
                "REFRESH_TOKEN_TABLE.AUTHORIZED_ORGANIZATION FROM IDN_OAUTH2_REFRESH_TOKEN REFRESH_TOKEN_TABLE " +
                "JOIN IDP IDP_TABLE ON REFRESH_TOKEN_TABLE.IDP_ID = IDP_TABLE.ID " +
                "LEFT JOIN IDN_OAUTH2_REFRESH_TOKEN_BINDING REFRESH_TOKEN_BINDING_TABLE ON " +
                "REFRESH_TOKEN_TABLE.REFRESH_TOKEN_ID = REFRESH_TOKEN_BINDING_TABLE.REFRESH_TOKEN_ID " +
                "WHERE REFRESH_TOKEN_TABLE.CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
                "CONSUMER_KEY = ?) AND AUTHZ_USER=? AND REFRESH_TOKEN_TABLE.TENANT_ID=? AND " +
                "REFRESH_TOKEN_TABLE.USER_DOMAIN=? AND REFRESH_TOKEN_TABLE.TOKEN_SCOPE_HASH=? AND " +
                "REFRESH_TOKEN_TABLE.TOKEN_STATE='ACTIVE' AND IDP_TABLE.NAME =? AND " +
                "IDP_TABLE.TENANT_ID=REFRESH_TOKEN_TABLE.TENANT_ID AND " +
                "REFRESH_TOKEN_BINDING_TABLE.TOKEN_BINDING_TYPE = ? AND " +
                "REFRESH_TOKEN_BINDING_TABLE.TOKEN_BINDING_REF = ? " +
                "ORDER BY REFRESH_TOKEN_TABLE.REFRESH_TOKEN_TIME_CREATED DESC";
        ...
        public static final String RETRIEVE_REFRESH_TOKEN_BINDING_BY_REFRESH_TOKEN_ID =
                "SELECT TOKEN_BINDING_TYPE, TOKEN_BINDING_REF, TOKEN_BINDING_VALUE " +
                        "FROM IDN_OAUTH2_REFRESH_TOKEN_BINDING WHERE REFRESH_TOKEN_ID = ?";
