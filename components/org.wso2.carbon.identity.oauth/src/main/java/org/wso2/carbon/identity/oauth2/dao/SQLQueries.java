...
public class SQLQueries {
    ...
    public static final String RETRIEVE_OLDEST_LIMIT_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_MYSQL = "SELECT " +
            "IDN_OAUTH2_ACCESS_TOKEN.ACCESS_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.TOKEN_ID FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "JOIN IDN_OAUTH_CONSUMER_APPS ON IDN_OAUTH2_ACCESS_TOKEN.CONSUMER_KEY_ID = IDN_OAUTH_CONSUMER_APPS.ID " +
            "WHERE IDN_OAUTH_CONSUMER_APPS.CONSUMER_KEY = ? AND IDN_OAUTH2_ACCESS_TOKEN.AUTHZ_USER = ? AND " +
            "IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID = ? AND IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN = ? AND " +
            "IDN_OAUTH2_ACCESS_TOKEN.TOKEN_STATE = 'ACTIVE' ORDER BY IDN_OAUTH2_ACCESS_TOKEN.TIME_CREATED LIMIT 5";

    public static final String RETRIEVE_OLDEST_LIMIT_ACTIVE_ACCESS_TOKEN_BY_CLIENT_ID_MSSQL = "SELECT TOP 5 " +
            "IDN_OAUTH2_ACCESS_TOKEN.ACCESS_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.TOKEN_ID FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "JOIN IDN_OAUTH_CONSUMER_APPS ON IDN_OAUTH2_ACCESS_TOKEN.CONSUMER_KEY_ID = IDN_OAUTH_CONSUMER_APPS.ID " +
            "WHERE IDN_OAUTH_CONSUMER_APPS.CONSUMER_KEY = ? AND IDN_OAUTH2_ACCESS_TOKEN.AUTHZ_USER = ? AND " +
            "IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID = ? AND IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN = ? AND " +
            "IDN_OAUTH2_ACCESS_TOKEN.TOKEN_STATE = 'ACTIVE' ORDER BY IDN_OAUTH2_ACCESS_TOKEN.TIME_CREATED";
