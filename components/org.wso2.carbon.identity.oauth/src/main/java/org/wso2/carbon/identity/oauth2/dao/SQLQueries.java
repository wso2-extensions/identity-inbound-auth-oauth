...
public class SQLQueries {
    ...
    public static final String GET_ACCESS_TOKENS_BY_BINDING_REFERENCE = "SELECT ACCESS_TOKEN, CONSUMER_KEY, " +
            "TOKEN_SCOPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID FROM (SELECT ACCESS_TOKEN, CONSUMER_KEY_ID, " +
            "TOKEN_ID, REFRESH_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN WHERE AUTHZ_USER = ?" + " AND TENANT_ID = ? " +
