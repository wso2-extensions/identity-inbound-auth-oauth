...
public class SQLQueries {
    ...
    public static final String DELETE_BINDINGS_OF_SCOPE = "DELETE FROM IDN_OAUTH2_SCOPE_BINDING WHERE SCOPE_ID = " +
            "(SELECT SCOPE_ID FROM IDN_OAUTH2_SCOPE WHERE NAME=? AND TENANT_ID=? AND SCOPE_TYPE=?)";
    ...
    public static final String RETRIEVE_OIDC_CLAIMS_COUNT_OF_SCOPE = "SELECT COUNT(*) FROM " +
            "IDN_OIDC_SCOPE_CLAIM_MAPPING WHERE SCOPE_ID= (SELECT SCOPE_ID FROM IDN_OAUTH2_SCOPE WHERE NAME=? AND " +
            "TENANT_ID=? AND SCOPE_TYPE=?) ";
