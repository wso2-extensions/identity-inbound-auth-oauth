...
public class SQLQueries {
    ...
    public static final String RETRIEVE_DEFAULT_TOKEN_TO_SESSION_MAPPING_COUNT = "SELECT COUNT(*) AS TOTAL FROM " +
            "IDN_OAUTH2_TOKEN_BINDING WHERE TOKEN_BINDING_VALUE = ? AND TOKEN_ID = ? " +
            "AND TOKEN_BINDING_TYPE = 'DEFAULT'";
