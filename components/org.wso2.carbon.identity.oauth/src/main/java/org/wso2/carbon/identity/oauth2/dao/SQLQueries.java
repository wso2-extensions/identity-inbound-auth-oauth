...
public class SQLQueries {
    ...
    public static final String
            RETRIEVE_LATEST_ACCESS_TOKEN_WITH_ACR_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_ORACLE =
            ...
            "GRANT_TYPE, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID=(SELECT ID FROM " +
    ...
    public static final String
            ...
            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD,TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
            "GRANT_TYPE, CONSENTED_TOKEN, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID=(SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? " +
            "AND TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_WITH_ACR_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MYSQL =
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, ACR " +
    ...
    public static final String
            ...
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
            "CONSENTED_TOKEN, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
            "TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC LIMIT 1";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_WITH_ACR_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_DB2SQL =
            "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
            "ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID= (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? " +
            "AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? " +
            "AND TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_WITH_ACR_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_MSSQL = "SELECT" +
            " TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
            "ACR FROM IDN_OAUTH2_ACCESS_TOKEN WITH (NOLOCK) WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND" +
            " TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC";
    ...
    public static final String
            ...
            "SELECT TOP 1 ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, " +
            "CONSENTED_TOKEN, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WITH (NOLOCK) WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
            "TOKEN_SCOPE_HASH=? AND TOKEN_BINDING_REF = ? AND IDP_ID=(SELECT ID FROM IDP WHERE NAME =? AND " +
            "TENANT_ID=IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID) ORDER BY TIME_CREATED DESC";
    ...
    public static final String RETRIEVE_LATEST_ACCESS_TOKEN_WITH_ACR_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_POSTGRESQL =
            "SELECT * FROM (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, " +
            "VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, " +
            "GRANT_TYPE, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND " +
    ...
    public static final String
            RETRIEVE_LATEST_ACCESS_TOKEN_WITH_ACR_BY_CLIENT_ID_USER_SCOPE_IDP_NAME_INFORMIX = "SELECT FIRST 1 * FROM" +
            " (SELECT ACCESS_TOKEN, REFRESH_TOKEN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_STATE, USER_TYPE, TOKEN_ID, SUBJECT_IDENTIFIER, GRANT_TYPE, ACR " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND AUTHZ_USER=? AND TENANT_ID=? AND USER_DOMAIN=? AND TOKEN_SCOPE_HASH=? " +
    ...
    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_IDP_NAME_WITH_ACR =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, " +
                    "USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
                    "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, IDP.NAME, ACR FROM " +
                    "(SELECT TOKEN_ID, CONSUMER_KEY,  AUTHZ_USER, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID AS TENANT_ID, " +
                    "IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN AS USER_DOMAIN,TIME_CREATED," +
                    "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
                    "REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.GRANT_TYPE AS GRANT_TYPE," +
                    "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN.IDP_ID AS IDP_ID, TOKEN_BINDING_REF, " +
                    "ACR FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN_HASH=? AND " +
                    "TOKEN_STATE='ACTIVE') IDN_OAUTH2_ACCESS_TOKEN " +
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE" +
                    " LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
                    "IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID = IDP.ID";

    public static final String RETRIEVE_ACTIVE_ACCESS_TOKEN_IDP_NAME_WITH_CONSENTED_TOKEN_WITH_ACR =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, " +
                    "USER_DOMAIN, TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
                    "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, IDP.NAME, CONSENTED_TOKEN, ACR FROM " +
                    "(SELECT TOKEN_ID, CONSUMER_KEY,  AUTHZ_USER, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID AS TENANT_ID, " +
                    "IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN AS USER_DOMAIN,TIME_CREATED," +
                    "REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, " +
                    "REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.GRANT_TYPE AS GRANT_TYPE," +
                    "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN.IDP_ID AS IDP_ID, TOKEN_BINDING_REF, " +
                    "CONSENTED_TOKEN, ACR FROM (SELECT * FROM IDN_OAUTH2_ACCESS_TOKEN WHERE ACCESS_TOKEN_HASH=? AND " +
                    "TOKEN_STATE='ACTIVE') IDN_OAUTH2_ACCESS_TOKEN " +
                    "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID) ACCESS_TOKEN_TABLE" +
                    " LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_TABLE.TOKEN_ID = " +
                    "IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID = IDP.ID";

    public static final String RETRIEVE_ACTIVE_EXPIRED_ACCESS_TOKEN_IDP_NAME_WITH_ACR =
            "SELECT CONSUMER_KEY, AUTHZ_USER, ACCESS_TOKEN_TABLE.TENANT_ID, USER_DOMAIN," +
                    "TOKEN_SCOPE, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD," +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, ACCESS_TOKEN_TABLE.TOKEN_ID, " +
                    "GRANT_TYPE, SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, IDP.NAME, ACR " +
                    "FROM (SELECT TOKEN_ID, CONSUMER_KEY, AUTHZ_USER, IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID, " +
                    "IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
                    "REFRESH_TOKEN_VALIDITY_PERIOD, USER_TYPE, REFRESH_TOKEN, IDN_OAUTH2_ACCESS_TOKEN.GRANT_TYPE, " +
                    "SUBJECT_IDENTIFIER, IDN_OAUTH2_ACCESS_TOKEN.IDP_ID, TOKEN_BINDING_REF, ACR " +
                    "FROM IDN_OAUTH2_ACCESS_TOKEN JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID " +
                    "WHERE ACCESS_TOKEN_HASH=? AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')) " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_IDP_NAME_WITH_ACR_MYSQL = "SELECT " +
            "ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, IDP.NAME, ACR " +
            "FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF," +
            " TIME_CREATED, VALIDITY_PERIOD, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID " +
            "FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED" +
            " DESC, TOKEN_STATE LIMIT 1) ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE " +
            "ON ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID " +
            "JOIN IDP ON IDP_ID=IDP.ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_ACR_DB2SQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, IDP.NAME, ACR " +
            "FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF, " +
            "TIME_CREATED, VALIDITY_PERIOD, ACR FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
            "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY " +
            "TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY) ACCESS_TOKEN_SELECTED LEFT JOIN " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_ACR_ORACLE = "SELECT ACCESS_TOKEN," +
            " AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE," +
            " REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE," +
            " SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, IDP.NAME, ACR " +
            "FROM (SELECT * FROM (SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, ACR " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE " +
            "CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_SELECTED.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID=IDP.ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_ACR_MSSQL = "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, IDP.NAME, ACR " +
            "FROM (SELECT TOP 1 ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, ACR FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM " +
            "IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_SELECTED" +
            ".TOKEN_ID  = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID=IDP.ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_ACR_POSTGRESQL = "SELECT " +
            "ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, IDP.NAME, ACR " +
            "FROM (SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF, " +
            "TIME_CREATED, VALIDITY_PERIOD, ACR " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ?) AND " +
            "REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC LIMIT 1) ACCESS_TOKEN_SELECTED " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_ACR_INFORMIX = "SELECT " +
            "ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, IDP.NAME, ACR " +
            "FROM (SELECT FIRST 1 ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_IDP_NAME_WITH_ACR = "INSERT INTO " +
            "IDN_OAUTH2_ACCESS_TOKEN (ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, TENANT_ID, " +
            "USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, REFRESH_TOKEN_VALIDITY_PERIOD, " +
            "TOKEN_SCOPE_HASH, TOKEN_STATE, USER_TYPE, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, " +
            "REFRESH_TOKEN_HASH, IDP_ID, TOKEN_BINDING_REF, ACR) SELECT ?,?,IDN_OAUTH_CONSUMER_APPS.ID,?,?,?,?,?,?,?," +
            "?,?,?,?,?,?,?,?,IDP.ID,?,? FROM IDN_OAUTH_CONSUMER_APPS, IDP WHERE IDP.NAME=? AND IDP.TENANT_ID=? " +
            "AND CONSUMER_KEY=?";
    ...
    public static final String INSERT_OAUTH2_ACCESS_TOKEN_WITH_IDP_NAME_WITH_CONSENTED_TOKEN_WITH_ACR =
            "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN (ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, " +
            "TENANT_ID, USER_DOMAIN, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, TOKEN_STATE, USER_TYPE, TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, ACCESS_TOKEN_HASH, REFRESH_TOKEN_HASH, IDP_ID, TOKEN_BINDING_REF, " +
            "CONSENTED_TOKEN, ACR) SELECT ?,?,IDN_OAUTH_CONSUMER_APPS.ID,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?," +
            "IDP.ID,?,?,? FROM IDN_OAUTH_CONSUMER_APPS, IDP WHERE IDP.NAME=? AND IDP.TENANT_ID=? AND CONSUMER_KEY=?";
    ...
    public static final String GET_DETAILED_ACTIVE_AUTHORIZATION_CODES_FOR_CONSUMER_KEY =
            "SELECT AUTHORIZATION_CODE, CODE_ID, TIME_CREATED, VALIDITY_PERIOD, SCOPE FROM "
                    + "IDN_OAUTH2_AUTHORIZATION_CODE WHERE CONSUMER_KEY_ID IN "
                    + "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE "
                    + "CONSUMER_KEY = ?) AND STATE = ? AND SCOPE LIKE '%openid%'";
