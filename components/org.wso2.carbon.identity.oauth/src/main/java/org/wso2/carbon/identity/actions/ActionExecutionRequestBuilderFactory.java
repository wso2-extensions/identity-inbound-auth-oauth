...
/**
 * ActionInvocationRequestBuilderFactory.
 */
public class ActionExecutionRequestBuilderFactory {

    private static final Map<ActionType, ActionExecutionRequestBuilder> actionInvocationRequestBuilders = new HashMap<>();

    public static ActionExecutionRequest buildActionInvocationRequest(ActionType actionType,
    ...
    public static void registerActionInvocationRequestBuilder(ActionType actionType,
