...
public class RefreshGrantHandler extends AbstractAuthorizationGrantHandler {
     ...
     * the applications that have enabled 'revokeTokensWhenIdPSessionTerminated'.
     *
    ...
    private void revokeSSOSessionBoundToken(String accessTokenIdentifier) {
        ...
        try {
            AccessTokenDO accessTokenDO = OAuth2Util.getAccessTokenDOFromTokenIdentifier(accessTokenIdentifier, true);
            ...
            log.error("User id not found for the access token: " + accessTokenIdentifier, e);
        }
    }
}
