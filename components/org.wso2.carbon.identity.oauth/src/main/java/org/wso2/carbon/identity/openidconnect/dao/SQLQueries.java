...
public class SQLQueries {
    ...
    public static final String RETRIEVE_BINDING_COUNT_OF_SCOPE = "SELECT COUNT(SCOPEBINDINGS.SCOPE_BINDING) FROM " +
            "IDN_OAUTH2_SCOPE SCOPES LEFT JOIN IDN_OAUTH2_SCOPE_BINDING SCOPEBINDINGS ON " +
            "SCOPES.ID=SCOPEBINDINGS.SCOPE_ID WHERE SCOPES.NAME = ? AND TENANT_ID = ?";
