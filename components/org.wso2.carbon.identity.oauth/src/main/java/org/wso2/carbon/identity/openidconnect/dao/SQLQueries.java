...
public class SQLQueries {
    ...
    /**
     * OIDC Scopes claims mapping related queries.
     */
    ...
    public static final String GET_ALL_IDN_OIDC_SCOPES = "SELECT TOP 1 ID FROM IDN_OIDC_SCOPE";
    ...
    public static final String GET_IDN_OIDC_SCOPES_CLAIMS = "SELECT NAME,CLAIM_URI  FROM IDN_OIDC_SCOPE LEFT JOIN " +
            ...
            "IDN_CLAIM ON IDN_CLAIM.ID =IDN_OIDC_SCOPE_CLAIM_MAPPING.EXTERNAL_CLAIM_ID";

    public static final String GET_IDN_OIDC_SCOPE = "SELECT TOP 1 ID FROM IDN_OIDC_SCOPE WHERE NAME=?";
