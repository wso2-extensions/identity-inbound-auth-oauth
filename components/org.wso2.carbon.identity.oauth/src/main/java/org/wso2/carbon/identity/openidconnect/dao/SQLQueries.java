...
public class SQLQueries {
    ...
    public static final String RETRIEVE_REQUESTED_CLAIMS_BY_SESSION_DATA_KEY = "SELECT CLAIM_ATTRIBUTE, ESSENTIAL, VALUE " +
            " FROM IDN_OIDC_REQ_OBJECT_CLAIMS" +
            " LEFT JOIN IDN_OIDC_REQ_OBJECT_REFERENCE" +
            " ON IDN_OIDC_REQ_OBJECT_CLAIMS.REQ_OBJECT_ID = IDN_OIDC_REQ_OBJECT_REFERENCE.ID" +
            " WHERE SESSION_DATA_KEYTOKEN_ID=? AND IS_USERINFO=? ";
