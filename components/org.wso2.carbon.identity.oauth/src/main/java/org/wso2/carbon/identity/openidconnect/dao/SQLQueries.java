...
public class SQLQueries {
    ...
    public static final String GET_IDN_OIDC_SCOPES_CLAIMS =
            "SELECT NAME, CLAIM_URI " +
            "FROM IDN_OIDC_SCOPE " +
            "LEFT JOIN IDN_OIDC_SCOPE_CLAIM_MAPPING " +
            "ON IDN_OIDC_SCOPE_CLAIM_MAPPING.SCOPE_ID = IDN_OIDC_SCOPE.ID " +
            "LEFT JOIN IDN_CLAIM " +
            ...
            "WHERE IDN_OIDC_SCOPE.TENANT_ID = ? " +
    ...
    public static final String DELETE_CLAIMS_FROM_SCOPE = "DELETE FROM IDN_OIDC_SCOPE_CLAIM_MAPPING WHERE " +
            ...
            "(SELECT * FROM IDN_OIDC_SCOPE_CLAIM_MAPPING) IDN_SCM LEFT JOIN IDN_OIDC_SCOPE " +
