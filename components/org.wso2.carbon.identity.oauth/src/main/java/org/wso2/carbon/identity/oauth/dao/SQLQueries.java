...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String GET_SP_OIDC_PROPERTY =
                "SELECT PROPERTY_VALUE FROM IDN_OIDC_PROPERTY WHERE TENANT_ID = ? AND CONSUMER_KEY = ? AND PROPERTY_KEY = ?";

        public static final String GET_SP_OIDC_PROPERTY_BY_APP_NAME = "SELECT PROPERTY_VALUE FROM IDN_OIDC_PROPERTY WHERE TENANT_ID = ? " +
        ...
        public static final String UPDATE_CONSUMER_APP_WITH_PKCE_AND_OWNER_UPDATE = "UPDATE IDN_OAUTH_CONSUMER_APPS SET " +
                "APP_NAME=?, CALLBACK_URL=?, GRANT_TYPES=?, PKCE_MANDATORY=?, PKCE_SUPPORT_PLAIN=?, " +
                "USER_ACCESS_TOKEN_EXPIRE_TIME=?, APP_ACCESS_TOKEN_EXPIRE_TIME=?, " +
    ...
    public static class OAuthConsumerDAOSQLQueries {
        ...
        public static final String GET_USERNAME_FOR_CONSUMER_KEY = "SELECT USERNAME FROM IDN_OAUTH_CONSUMER_APPS " +
                "WHERE CONSUMER_KEY=?";
