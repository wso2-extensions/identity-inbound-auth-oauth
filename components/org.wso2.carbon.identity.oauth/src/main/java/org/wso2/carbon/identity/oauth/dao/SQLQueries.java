...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String GET_ALL_SP_OIDC_PROPERTIES =
                "SELECT PROPERTY_KEY, PROPERTY_VALUE FROM IDN_OIDC_PROPERTY WHERE TENANT_ID = ? AND CONSUMER_KEY = ?";

        public static final String GET_SP_OIDC_PROPERTY =
                "SELECT PROPERTY_VALUE FROM IDN_OIDC_PROPERTY WHERE TENANT_ID = ? AND CONSUMER_KEY = ? " +
                        "AND PROPERTY_KEY = ?";

        public static final String GET_SP_OIDC_PROPERTY_BY_APP_NAME = "SELECT PROPERTY_VALUE FROM IDN_OIDC_PROPERTY " +
                "WHERE TENANT_ID = ? AND " +
                "CONSUMER_KEY = (SELECT CONSUMER_KEY FROM IDN_OAUTH_CONSUMER_APPS WHERE TENANT_ID = ? AND " +
                "APP_NAME =?) AND PROPERTY_KEY = ?";
