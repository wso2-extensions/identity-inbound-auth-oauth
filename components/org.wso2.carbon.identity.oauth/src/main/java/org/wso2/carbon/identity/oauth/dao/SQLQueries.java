...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String REMOVE_SP_ASSOCIATIONS_BY_CONSUMER_ID = "DELETE FROM SP_INBOUND_AUTH " +
                "WHERE INBOUND_AUTH_KEY = ? AND TENANT_ID = ?";

        public static final String REMOVE_APPLICATION = "DELETE FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=? AND TENANT_ID=?";
