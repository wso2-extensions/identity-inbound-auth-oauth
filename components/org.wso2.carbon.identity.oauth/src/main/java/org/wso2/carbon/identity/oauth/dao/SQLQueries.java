...
public class SQLQueries {
    ...
    public static class OAuthAppDAOSQLQueries {
        ...
        public static final String ADD_OAUTH_APP_CALLBACK_URL = "INSERT INTO IDN_OAUTH2_APP_CALLBACK_URLS" +
        ...
        public static final String GET_APP_INFO = "SELECT CONSUMER_SECRET, USERNAME, APP_NAME, OAUTH_VERSION, " +
                ...
                " APP_ACCESS_TOKEN_EXPIRE_TIME, REFRESH_TOKEN_EXPIRE_TIME, ID_TOKEN_EXPIRE_TIME," +
                " APP_STATE FROM IDN_OAUTH_CONSUMER_APPS" +
                " WHERE CONSUMER_KEY=? ";
        ...
        public static final String GET_APP_INFO_WITH_PKCE = "SELECT CONSUMER_SECRET,USERNAME,APP_NAME, OAUTH_VERSION," +
                ...
                "USER_ACCESS_TOKEN_EXPIRE_TIME, APP_ACCESS_TOKEN_EXPIRE_TIME, REFRESH_TOKEN_EXPIRE_TIME, " +
                "ID_TOKEN_EXPIRE_TIME, APP_STATE FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY=? ";
        ...
        public static final String UPDATE_CONSUMER_APP_WITH_OWNER_UPDATE = "UPDATE IDN_OAUTH_CONSUMER_APPS SET " +
                ...
                "APP_ACCESS_TOKEN_EXPIRE_TIME=?, REFRESH_TOKEN_EXPIRE_TIME=?, ID_TOKEN_EXPIRE_TIME=?, " +
                "USERNAME=?, USER_DOMAIN=? WHERE CONSUMER_KEY=?";
        ...
        public static final String GET_OAUTH_APP_CALLBACK_URLS = "SELECT CALLBACK_URL " +
                "FROM IDN_OAUTH2_APP_CALLBACK_URLS WHERE APP_ID=?";

        public static final String REMOVE_APP_SCOPE_VALIDATORS = "DELETE FROM IDN_OAUTH2_SCOPE_VALIDATORS " +
                "WHERE APP_ID=?";

        public static final String REMOVE_OAUTH_APP_CALLBACK_URLS = "DELETE FROM IDN_OAUTH2_APP_CALLBACK_URLS " +
                "WHERE APP_ID=?";
