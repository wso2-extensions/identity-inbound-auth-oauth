...
public interface ActionExecutionResponseProcessor {
    ...
    ActionExecutionStatus processResponse(ActionType actionType, Map<String, Object> eventContext, Event actionEvent,
                                          ActionExecutionResponse actionExecutionResponse) throws
