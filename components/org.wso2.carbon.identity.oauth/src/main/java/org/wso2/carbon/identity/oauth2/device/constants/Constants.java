...
public class Constants {
    ...
    public static final String PROXY_ENABLE = "JWTValidatorConfigs.HTTPProxy.Enable";
    public static final String PROXY_HOST = "JWTValidatorConfigs.HTTPProxy.Host";
    public static final String PROXY_PORT = "JWTValidatorConfigs.HTTPProxy.Port";
    public static final String PROXY_USERNAME = "JWTValidatorConfigs.HTTPProxy.Username";
    public static final String PROXY_PASSWORD = "JWTValidatorConfigs.HTTPProxy.Password";
