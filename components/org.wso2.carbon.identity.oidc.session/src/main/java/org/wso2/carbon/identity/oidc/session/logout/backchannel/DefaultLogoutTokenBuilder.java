...
public class DefaultLogoutTokenBuilder implements LogoutTokenBuilder {
    ...
    private JWTClaimsSet buildJwtToken(OIDCSessionState sessionState, String tenantDomain, String clientID)
        ...
        List<String> audience = getAudienceForLogoutToken(clientID);
    ...
    private long getLogoutTokenExpiryInMillis() {
        ...
        return Integer.parseInt(config.getOpenIDConnectBCLogoutTokenExpiration()) * 1000L;
    }

    /**
     * Returns the audience for the logout token
     *
     * @param clientID
     * @return Audience
     */
    private List<String> getAudienceForLogoutToken(String clientID) {
